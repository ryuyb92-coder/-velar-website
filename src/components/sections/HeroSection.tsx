...
/* ─── SVG Sports Coupe ──────────────────────────────────────────────────────
   ...
   IMPORTANT: gradient IDs are prefixed with "hero" to avoid conflicts with any
...
function CarSVG() {
  return (
    ...
    >
      <defs>
        <linearGradient id="heroBodyMain" x1="0.1" y1="0" x2="0.1" y2="1">
        ...
        <linearGradient id="heroBodySide" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%"   stopColor="#1a1816"/>
          <stop offset="60%"  stopColor="#111010"/>
          <stop offset="100%" stopColor="#0a0908"/>
        </linearGradient>
        <linearGradient id="heroHoodGrad" x1="0.5" y1="0" x2="0.5" y2="1">
          <stop offset="0%"   stopColor="#222018"/>
          <stop offset="50%"  stopColor="#141210"/>
          <stop offset="100%" stopColor="#0c0a08"/>
        </linearGradient>
        <linearGradient id="heroWindshield" x1="0.2" y1="0" x2="0.7" y2="1">
        ...
        <linearGradient id="heroShoulderLine" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%"   stopColor="white" stopOpacity="0"/>
        ...
        <linearGradient id="heroMidLine" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%"   stopColor="white" stopOpacity="0"/>
          <stop offset="38%"  stopColor="white" stopOpacity="0.12"/>
          <stop offset="56%"  stopColor="white" stopOpacity="0.14"/>
          <stop offset="100%" stopColor="white" stopOpacity="0"/>
        </linearGradient>
        <radialGradient id="heroTailGlow" cx="100%" cy="50%" r="75%">
        ...
        <radialGradient id="heroGroundShadow" cx="50%" cy="50%" r="50%">
          <stop offset="0%"   stopColor="#000000" stopOpacity="0.88"/>
          <stop offset="100%" stopColor="#000000" stopOpacity="0"/>
        </radialGradient>
        <radialGradient id="heroWellShadow" cx="50%" cy="100%" r="60%">
      ...
      {/* Ground shadow */}
      <ellipse cx="435" cy="346" rx="410" ry="18" fill="url(#heroGroundShadow)"/>
      ...
      <g transform="translate(0,346) scale(1,-0.14)" opacity="0.28">
        <path d="M 60 190 Q 110 205 165 212 L 190 228 Q 230 240 310 242 L 580 238 Q 640 234 688 222 L 742 208 Q 778 196 808 180 L 820 170 L 820 270 L 60 270 Z"
          fill="url(#heroBodyMain)" opacity="0.35"/>
      </g>
      ...
      {/* Main coupe body */}
      <path d="M 60 270 L 65 262 L 80 244 Q 98 228 122 218 L 158 208 Q 176 204 195 202 L 212 200 Q 228 190 248 176 L 272 158 Q 282 142 298 134 L 330 124 L 396 114 L 500 112 L 554 116 L 588 124 Q 610 132 630 145 L 654 162 Q 668 172 683 182 L 718 194 Q 742 202 768 210 L 790 220 Q 806 228 814 242 L 820 258 L 820 270 Z" fill="url(#heroBodyMain)"/>

      {/* Hood panel */}
      <path d="M 65 265 L 80 246 Q 96 230 118 220 L 155 210 L 192 202 L 208 200 L 210 205 L 196 208 L 162 216 Q 128 226 112 236 L 96 250 L 82 266 Z" fill="url(#heroHoodGrad)"/>

      {/* Upper body shoulder zone */}
      <path d="M 200 200 Q 240 192 280 178 Q 308 168 326 158 Q 350 146 384 132 Q 424 120 500 116 Q 556 116 590 124 Q 614 132 636 148 Q 655 162 669 174 Q 692 190 720 196 L 718 194 Q 742 202 768 210 L 790 220 Q 806 228 814 242 L 820 258 L 820 270 Q 794 262 768 255 L 724 248 Q 695 242 668 236 L 636 228 Q 614 222 590 216 L 554 212 Q 520 210 500 210 L 440 210 Q 400 212 360 218 Q 320 226 286 234 Q 258 240 228 246 L 200 252 Z" fill="url(#heroBodySide)"/>

      {/* Roof key-light highlight */}
      <path d="M 300 120 Q 400 110 500 112 Q 554 114 586 122 L 598 128" fill="none" stroke="url(#heroKeyLight)" strokeWidth="2.5" strokeLinecap="round"/>

      {/* Shoulder highlight */}
      <path d="M 205 198 Q 248 190 286 178 Q 316 168 338 158 Q 362 148 396 136 Q 436 126 500 122 Q 558 122 594 130 Q 620 138 644 154 Q 664 168 678 180 Q 700 192 726 198" fill="none" stroke="url(#heroShoulderLine)" strokeWidth="2" strokeLinecap="round"/>

      {/* Mid-body character crease */}
      <path d="M 90 238 Q 148 230 208 224 Q 268 220 320 214 Q 380 208 440 205 Q 498 204 558 206 Q 610 210 654 216 Q 704 224 756 234 L 800 244" fill="none" stroke="url(#heroMidLine)" strokeWidth="1.5" strokeLinecap="round"/>

      {/* Windshield */}
      <path d="M 298 136 L 330 124 L 404 114 L 500 112 L 516 114 L 512 118 L 448 120 L 374 122 L 340 130 L 320 142 L 308 152 Z" fill="url(#heroWindshield)"/>
      ...
      {/* Rear glass / C-pillar */}
      <path d="M 516 114 L 556 118 L 588 126 L 608 140 L 610 152 L 600 160 L 575 148 L 546 134 L 520 124 Z" fill="url(#heroRearGlass)"/>
      ...
      {/* Orange tail ambient */}
      <ellipse cx="826" cy="248" rx="70" ry="60" fill="url(#heroTailGlow)"/>
      ...
      {/* FRONT WHEEL */}
      <path d="M 155 268 Q 155 234 186 224 Q 213 216 240 224 Q 267 234 267 268 Z" fill="url(#heroWellShadow)" opacity="0.65"/>
      <ellipse cx="211" cy="272" rx="57" ry="57" fill="#060504"/>
      <ellipse cx="211" cy="272" rx="53" ry="53" fill="url(#heroTireGrad)"/>
      <ellipse cx="211" cy="272" rx="40" ry="40" fill="url(#heroRimGrad)"/>
      ...
      {/* REAR WHEEL */}
      <path d="M 610 268 Q 610 232 644 222 Q 672 214 700 222 Q 728 232 728 268 Z" fill="url(#heroWellShadow)" opacity="0.65"/>
      <ellipse cx="669" cy="272" rx="57" ry="57" fill="#060504"/>
      <ellipse cx="669" cy="272" rx="53" ry="53" fill="url(#heroTireGrad)"/>
      <ellipse cx="669" cy="272" rx="40" ry="40" fill="url(#heroRimGrad)"/>
      <g stroke="rgba(255,255,255,0.14)" strokeWidth="1.6" strokeLinecap="round">
